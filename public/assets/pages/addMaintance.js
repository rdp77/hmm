...
$("#addMTBF").click(function () {
    $("#mtbf").append(
        '<div class="row"><div class="col"><div class="form-group">' +
            ...
            '<div class="input-group mb-2"><input type="text" class="form-control text-right" name="time_damaged[]"><div class="input-group-append">' +
...
$("#addMTTR").click(function () {
    $("#mttr").append(
        '<div class="row"><div class="col"> <div class="form-group"> <label class="control-label">Total Maintenance<code>*</code>' +
            '</label> <div class="input-group mb-2"> <input type="text" class="form-control text-right" name="total_maintenance[]"> <div class="input-group-append">' +
